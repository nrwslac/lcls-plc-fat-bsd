...
epicsEnvSet("IOCNAME", "ioc-fat-bsd" )
epicsEnvSet("ENGINEER", "pcds" )
epicsEnvSet("LOCATION", "PLC:BSD:FAT" )
...
epicsEnvSet("IPADDR",           "5.119.157.218")
epicsEnvSet("AMSID",            "5.119.157.218.1.1")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:BSD:FAT")
dbLoadRecords("save_restoreStatus.db", "P=PLC:BSD:FAT:")
...
save_restoreSet_status_prefix( "PLC:BSD:FAT:" )
